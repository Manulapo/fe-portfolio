...
const MobileTopBar = () => (
  <NavigationMenu className="flex justify-between mx-auto md:h-14 md:border-b md:border-gray-secondary max-w-full bg-card fixed top-0 z-50">
    <div className="w-full h-full flex justify-between items-center">
      <div className="w-full flex justify-around items-center p-2 border-b border-gray-secondary list-none">
  ...
  return (
    <>
      ...
      <NavigationMenu className="flex justify-center mx-auto h-14 border-t md:border-b border-b-0 md:border-gray-200 max-w-full bg-card dark:bg-card dark:border-[#333] fixed bottom-0 md:top-0 z-50">
        <div className="lg:w-[85%] md:w-[90%] max-w-[1400px] mx-auto w-full h-full flex justify-between items-center">
